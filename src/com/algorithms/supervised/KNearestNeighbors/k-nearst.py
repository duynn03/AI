...
# k=1 nghĩa là: mỗi điểm test data, chỉ xét 1 điểm training data gần nhất và lấy label của điểm đó để dự đoán cho điểm test này.
...
# ==> kết quả 94% khá chính xác (chỉ lệch kết quả của 2 3 điểm data)
