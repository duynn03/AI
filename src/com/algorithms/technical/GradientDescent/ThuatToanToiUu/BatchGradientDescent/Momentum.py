...
# https://github.com/tiepvupsu/tiepvupsu.github.io/blob/master/assets/GD/LR%20Momentum.ipynb
...
def GD_momentum(theta_init, grad, eta, gamma):
    ...
    for it in range(100):
        v_new = gamma * v_old[-1] + eta * grad(theta[-1])
...
# demo: https://machinelearningcoban.com/assets/GD/LR_momentum_contours.gif
print(it_mm, w_mm)

# Momentum with contours
# công thức của những hình ellipse ở contours
N = X.shape[0]
